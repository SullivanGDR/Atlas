...
## Schematic — première version locale

- Route : /tools/schematic (ancienne route db-designer redirigée).
...
TypeScript, lint et 7 tests locaux réussis : registre, round-trip JSON, version/références invalides, suppression en cascade, propagation des types sans mutation et protection des clés référencées.
